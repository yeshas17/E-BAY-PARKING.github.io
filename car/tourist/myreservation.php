		...
		// delete reserved
		 ...
		 <br />
		 	 <table id="myTable" class="table table-striped" >  
				<thead>
					<th><center>NAME OF PARKING LOCATION/IAMGE</center></th>
					<th>NO OF PARKING AVALIABLE</th>
					<th>PARKING OPERATOR NAME</th>
					<th>YOUR VECHICAL NO:</th>
					<th>DATE</th>
					<th>TIME</th>
					<th>PRICE</th>
					<th><center>CANCLE</center></th>
				</thead>
				<tbody>
					<?php 
			$tid = $_SESSION['tourID'];
