				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse navbar-ex1-collapse">
						...
						<ul class="nav navbar-nav" style="font-family: Times New Roman;">
							...
							<li>
								<a href="myreservation.php">My Booking History</a>
							</li>
							<li>
								<a href="myreservation.php"></a>
							</li>
						</ul>
...
<!-- begin content -->
	<div class="container-fluid">
		...
		<div class="panel panel-info">
		  <div class="panel-heading">List of Vehical Booking Available</div>
						    ...
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						      		<div class="row">
						      			...
						      			<div class="col-md-6">
						      				<form>
						      					<strong>Name of Parking location </strong><?php echo $bName; ?><br />
							      				<strong>NO OF PARKING AVALIBALE: </strong><?php echo $bCap; ?><br />
							      				<strong>Price: </strong><?php echo 'Php '.number_format($bPrice, 2); ?><br />
							      				<strong>Vehical Type:</strong><?php echo $bON; ?> <br />
							      				<strong>ADD OUR VEHICAL NO: </strong> <br />
