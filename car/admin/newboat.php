				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse navbar-ex1-collapse">
						...
						<ul class="nav navbar-nav" style="font-family: Times New Roman;">
							<li class="active">
								<a href="index.php">VEHICAL PARKING LOCATION</a>
							</li>
							<li>
								<a href="reservation.php">CUSTOMER BOOKING</a>
							</li>
						</ul>
			...
			<br />
				...
				<form action = "" method = "POST" enctype="multipart/form-data">
					   ...
					   <div class="form-group">
					    <label for="inputdefault">NAME OF PARKING LOCATION:</label>
					  ...
					  <div class="form-group">
					    ...
					    <div class="form-group">
				    	  <label for="inputdefault">PARKING LOCATION Picture:</label>
