				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse navbar-ex1-collapse">
						<ul class="nav navbar-nav">
							<li><a href="#" style="font-family: Times New Roman; font-size: 30px;">E-BAY PARKING</a></li>
						</ul>

						<ul class="nav navbar-nav" style="font-family: Times New Roman;">
							<li class="active">
								<a href="index.php">PARKING LOCATIONS</a>
							</li>
							<li>
								<a href="reservation.php">CUSTERMER BOOKING</a>
							</li>
						</ul>
			...
			<br />
				...
				<form action = "" method = "POST" enctype="multipart/form-data">
								 ...
								 if(isset($_POST['updateboat']))
								 	{
										...
										$bPrice = null;
										if($bcpcty == '1 or 2 SLOT'){
											$bPrice = 30;
										}else if($bcpcty == '1 or 2 SLOT'){
											$bPrice =40;
										}else{
											$bPrice = 50;
					   ...
					   <div class="form-group">
					    <label for="inputdefault">NAME OF PARKING LOCATIONS:</label>
					  ...
					  <div class="form-group">
					    <label for="inputdefault">VECHICAL TYPE:</label>
					    <input class="form-control" id="inputdefault" name="bON" type="text" value ="<?php echo $bon; ?>">
					  </div>

					  <div class="form-group">
					    <label for="inputdefault">SLOT BOOKING:</label><br />
					    <select name = "bC" class = "btn-lg" style = "width:250px;">
					    	<option <?php if($bcpcty == '15 Persons'){echo 'selected';} ?> value = "30 Persons">1 SLOT</option>
					    	<option <?php if($bcpcty == '25 Persons'){echo 'selected';} ?> value = "40 Persons">2 SLOT</option>
					  ...
					  <input type="hidden" name="oldbimg" value="<?php echo $getoldbimg; ?>">
					   ...
					   <div class="form-group">
				    	  <label for="inputdefault">LOCATION/IMAGE:</label>
